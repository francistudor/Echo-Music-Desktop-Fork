...
class S {
  ...
  /// `Echo`
  String get Echo {
    return Intl.message('Echo', name: 'Echo', desc: '', args: []);
  }
  ...
  /// `Click here disable battery optimisation for Echo to work properly`
  ...
  /// `Support the development of Echo`
