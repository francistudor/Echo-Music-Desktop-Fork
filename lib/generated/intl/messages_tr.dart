...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "Battery_Optimisation_message": MessageLookupByLibrary.simpleMessage(
      "Echo un düzgün çalışması için pil optimizasyonunu devre dışı bırakmak için buraya tıklayın",
    ),
    ...
    "Donate_Message": MessageLookupByLibrary.simpleMessage(
      "Echo un geliştirilmesini destekleyin",
    ),
    ...
    "Search_Echo": MessageLookupByLibrary.simpleMessage("Echo Ara"),
